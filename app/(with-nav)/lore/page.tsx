    ...
    <div>
      ...
      {isLoading && (
        <div className="flex items-center justify-center relative z-10" style={{ minHeight: 'calc(100dvh - 200px)' }}>
          <div className="text-center">
            ...
            <p className="font-alex-brush text-white text-3xl">loading lore...</p>
          </div>
        </div>
      )}
      ...
      {error && (
        <div className="mx-auto max-w-6xl p-6 relative z-10">
          <h1 className="text-3xl font-bold mb-6">Lore & Stories</h1>
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-8 text-center">
            ...
            <h2 className="text-xl font-semibold text-red-800 mb-2">Unable to Load Lore Collections</h2>
            <p className="text-red-700 mb-4">
              We're experiencing some technical difficulties loading our lore collections. 
      ...
      {!isLoading && !error && (
        ...
        <div className="text-center py-10 px-6">
          ...
          <p className="text-xl text-gray-100 max-w-4xl mx-auto drop-shadow-md leading-relaxed">
            Discover the tales and stories behind each piece of artwork. 
            From spooky wisps to whimsical faeries, every creation has a story to tell.
          </p>
        ...
        <div className="grid grid-cols-1 tablet:grid-cols-2 lg:grid-cols-3 gap-8 px-6">
          ...
          {(!collections || collections.length === 0) && (
            <div className="text-center py-12 col-span-full">
              <p className="text-gray-600 text-lg">No lore collections found.</p>
            </div>
          )}
        </div>
        </motion.div>
