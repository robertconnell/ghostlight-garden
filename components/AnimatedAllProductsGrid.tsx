...
interface AnimatedAllProductsGridProps {
  products: Product[];
  searchTerm?: string;
}
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 relative">
              ...
              {product.isFromLimitedCollection && (
                <div className="absolute top-3 right-3 z-10">
                  <svg className="w-8 h-8 text-pink-200" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-2">
                  ...
                  {product.isFromLimitedCollection && (
                    <span className="text-lg text-pink-200 font-bold ml-2">
                      Limited
                    </span>
                  )}
                </div>
